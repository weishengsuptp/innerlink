...
// broadcast domain 鈥?a /24 in the same VLAN, same switch,
...
// IPv4 only (IPv6 is out of scope for v0.5.1 鈥?no one
...
// bound to. Used to skip "scan myself" entries 鈥?we
...
// need to preserve the full error 鈥?the user can
