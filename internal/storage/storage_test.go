...
// key here 鈥?the storage layer only sees the raw 32
...
func TestWrongKeyFailsDecrypt(t *testing.T) {
	...
	// Read with keyB 鈥?should get ErrCorrupt, not panic.
	//
...
func TestConcurrentAppendsAreSerialized(t *testing.T) {
	...
	// records without corruption 鈥?the mutex inside
...
// TestAppendNilRecordRejected: defensive check 鈥?passing
