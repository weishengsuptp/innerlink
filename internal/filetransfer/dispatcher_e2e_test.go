...
// drop it 鈥?so Send would block forever on wait accept.
//
...
import (
	...
	ft "github.com/weishengsuptp/innerlink/internal/filetransfer"
...
func TestSendFile_WithSharedChannelPump(t *testing.T) {
	...
	// envelopes off chA 鈥?including the Accept reply
...
func channelPairE2E(t *testing.T) (*protocol.Channel, *protocol.Channel) {
	...
	// gone, the test will fail to compile 鈥?fix that by
...
// test needs this on BOTH sides of the channel pair 鈥?the
